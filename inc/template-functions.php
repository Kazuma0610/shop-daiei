...
function welcart_mode_campaign_message( $post_id = null ) {
	...
	echo wp_kses_post( get_welcart_mode_campaign_message( $post_id ) );
...
function mode_get_produt_tag( $post_id = null ) {
	...
	if ( isset( $flag['new'] ) || isset( $flag['reco'] ) || usces_have_fewstock( $post_id ) || welcart_mode_has_campaign( $post_id ) ) {
		...
		if ( isset( $flag['new'] ) ) {
			$html .= '<li class="new">' . __( 'New', 'welcart_mode' ) . '</li>' . "\n";
		}
		if ( isset( $flag['reco'] ) ) {
			$html .= '<li class="recommend">' . __( 'Recommend', 'welcart_mode' ) . '</li>' . "\n";
		}
		if ( usces_have_fewstock( $post_id ) ) {
			$html .= '<li class="stock">' . __( 'Few Stock', 'welcart_mode' ) . '</li>' . "\n";
		}
		if ( welcart_mode_has_campaign( $post_id ) ) {
			$html .= '<li class="sale">' . __( 'Sale', 'welcart_mode' ) . '</li>' . "\n";
		}
		$html .= '</ul>' . "\n";
	}
...
function mode_produt_tag( $post_id = null ) {
	...
	echo wp_kses_post( mode_get_produt_tag( $post_id ) );
