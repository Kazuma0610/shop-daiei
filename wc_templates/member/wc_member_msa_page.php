	...
	<article class="post" id="wc_member_msa">
		<div class="column980 member-page">
			...
			<div id="memberpages">
				...
				<div class="member_submenu">
					<div class="edit_member"><a href="<?php echo esc_url( USCES_MEMBER_URL ); ?>">会員ページトップへ戻る</a></div>
					<?php do_action( 'usces_action_member_submenu_list' ); ?>
				</div>
				<?php if ( ! empty( $usces->options['member_page_data']['header']['changepass'] ) ) : ?>
				...
				<div class="msa_area">
					...
					<div class="msa_field_block">
						...
						<div class="msa_field"><label for="msa_name">氏名（必須）</label>姓<input id="msa_name" name="msa_name" type="text" />名<input id="msa_name2" name="msa_name2" type="text" /><span id="name_message" class="msa_message"></span></div>
						<div class="msa_field"><label for="msa_furigana">フリガナ</label>姓<input id="msa_furigana" name="msa_furigana" type="text" />名<input id="msa_furigana2" name="msa_furigana2" type="text" /></div>
						<div class="msa_field"><label for="msa_zip">郵便番号（必須）</label><input id="msa_zip" name="msa_zip" type="text" />
							<?php
						...
						<div class="msa_field"><label for="msa_pref">都道府県（必須）</label>
						...
						<div class="msa_field"><label for="msa_address1">市区町村（必須）</label><input id="msa_address1" name="msa_address1" type="text" /><span id="address1_message" class="msa_message"></span></div>
						<div class="msa_field"><label for="msa_address2">番地（必須）</label><input id="msa_address2" name="msa_address2" type="text" /><span id="address2_message" class="msa_message"></span></div>
						<div class="msa_field"><label for="msa_address3">ビル名など</label><input id="msa_address3" name="msa_address3" type="text" /></div>
						<div class="msa_field"><label for="msa_tel">電話番号（必須）</label><input id="msa_tel" name="msa_tel" type="text" /><span id="tel_message" class="msa_message"></span></div>
						<div class="msa_field"><label for="msa_tel">FAX番号</label><input id="msa_fax" name="msa_fax" type="text" /><span id="fax_message" class="msa_message"></span></div>
