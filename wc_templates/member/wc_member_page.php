			...
			<div class="column980 member-page">
				...
				<div id="memberinfo">
					...
					<ul class="member_submenu">
						<li><ul><?php do_action( 'usces_action_member_submenu_list' ); ?></ul></li>
					...
					<div class="user-edit-info">
						...
						<form action="<?php usces_url( 'member' ); ?>#edit" method="post" onKeyDown="if(event.keyCode == 13){return false;}">
							...
							<?php if (isset($_SESSION['watched_page'])): ?>
			                    <div class="watched_page_wrap">
			                      <h3 class="mypage-h3">最近チェックしたアイテム</h3>
                                             ...
                                             <?php else: ?>
								                <li>
                                                   <a href="<?php echo get_permalink($wp); ?>">
                                                      <div class="thumbnail-img"><?php echo get_the_post_thumbnail($wp, array(200, 200)); ?></div>
								                      <div class="watched_info"><?php echo get_the_title( $wp ); ?></div>
                                                   </a>
							                    </li>
                                             <?php $i++; ?>
                                             <?php endif; ?>
