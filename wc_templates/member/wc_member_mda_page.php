				...
				<div class="msa_area">
					<div class="msa_total"><?php esc_html_e( 'Number of registrations', 'wcexda' ); ?><span id="msa_num">0</span><?php esc_html_e( 'addresses', 'wcexda' ); ?><input id="new_destination" type="button" value="<?php esc_attr_e( 'Adding a new shipping address', 'wcexda' ); ?>" /></div>
							...
							if ( isset( $_GET['mda_backurl'] ) && wp_verify_nonce( $nonce, WCEX_DA_Member_Page::WPNONCE ) ) :
								...
								<div class="allocation_dialog_exp"><?php echo wp_kses_post( '1. Click "Register New Shipping Address" to go to the new registration screen. <br>2. When you have finished entering your name and address, press "Register". <br>3. When you have completed your registration, press "Return to Shipping Address Settings" at the bottom of the screen. <br><br>You cannot delete a shipping address that is marked as (Yourself). To change or delete a registered shipping address, select a shipping address other than (you) from "Select a shipping address to edit".', 'wcexda' ); ?></div>
							<?php else : ?>
								<div class="allocation_dialog_exp"><?php echo wp_kses_post( '1. Click "Register New Shipping Address" to go to the new registration screen. <br>2. When you have finished entering your name and address, press "Register". <br><br>You cannot delete a shipping address that is marked as (Yourself). To change or delete a registered shipping address, select a shipping address other than (you) from "Select a shipping address to edit".', 'wcexda' ); ?></div>
							<?php endif; ?>
